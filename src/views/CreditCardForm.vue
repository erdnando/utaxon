...
<div class="wrapper" id="app">
    <div class="card-form" style="backround-color:blue">
      <div class="card-list" >
      ...
      <div class="card-form__inner">
        ...
        <div class="card-input">
            <label for="cardNumber" class="card-input__label">Ingrese sus datos para adquirir el plan de servicio de UTax On</label>
          <label for="cardNumber" class="card-input__label">Número de tarjeta</label>
          <input type="text" id="cardNumber" class="card-input__input" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off">
        </div>
        <div class="card-input">
          <label for="cardName" class="card-input__label">Nombre completo</label>
